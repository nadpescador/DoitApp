            ...
            BlocBuilder<CounterPageCubit, CounterPageState>(
              builder: (context, state) {
                return state.when(
                      ...
                      children: [
                        ...
                        Container(
                          child: CircularCountDownTimer(
                            ...
                            autoStart: true,
                            onStart: () async {
                              soundProvider.playEndOfRestingAudio();
                              await Future.delayed(Duration(seconds: 1));
                              soundProvider.playUpBeatTrainingSound();
                            },
                            onComplete: () {
                              soundProvider.playStartTrainingAudio();
                              if (repetitions == 1) {
                  ...
                  resting: (workTime, restTime, repetitions) {
                    return Column(
                      children: [
                        Text(
                        ...
                        CircularCountDownTimer(
                          ...
                          onComplete: () {
                            soundProvider.playEndOfRestingAudio();
                            context.read<CounterPageCubit>().playTraining();
                          },
                        ),
                      ],
                    );
