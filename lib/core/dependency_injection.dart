...
Future<void> init() async {
  ...
  getIt.registerLazySingleton<PersistanceService>(
      () => PersistanceService(documentDirectory: documentDirectory.path));
  getIt.registerLazySingleton<HistoricalRepository>(
      () => HistoricalRepository(persistanceService: getIt()));
}
